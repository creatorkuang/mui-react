...
const Clock = React.createClass({
  ...
  _getButtons() {
    ...
    if (this.props.format === 'ampm'){
      buttons = [
        <ClockButton key="AM" position="left" onClick={this._setAffix.bind(this, "am")} selected={isAM} >{"AM"}</ClockButton>,
        <ClockButton key="PM" position="right" onClick={this._setAffix.bind(this, "pm")} selected={!isAM} >{"PM"}</ClockButton>,
      ];
    }
    return buttons;
  },
